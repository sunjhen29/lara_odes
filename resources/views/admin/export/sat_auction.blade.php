  ...
  <div class="col-xs-12">
    ...
    <div class="box">
      <div class="box-header">
        ...
        <div class="box-tools">
          <div>
            <a href="{{ url('/admin/export/sat_auction/'.$batch->id) }}"><button class="btn btn-success btn-md addbutton pull-right"><i class="fa fa-download" aria-hidden="true"></i>  Export to CSV</button></a>
            <a href="{{ url('/admin/export/sat_auction/'.$batch->id.'/excel') }}"><button class="btn btn-success btn-md addbutton pull-right"><i class="fa fa-file-excel-o" aria-hidden="true"></i>  Export to Excel</button></a>
          </div>
        </div>
      </div>
      <!-- /.box-header -->
