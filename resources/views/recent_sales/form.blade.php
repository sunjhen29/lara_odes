<div class="box-body">
    ...
    <div class="row">
        ...
        <div class="col-sm-2 col-md-2">
            {!! Form::select('street_ext', ['Street','Road'], null, ['class'=>'form-control input-sm','placeholder'=>'--']) !!}
        </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-4 col-md-3">
            {!! Form::select('sale_type', ['Normal Sale','Sold At Auction'], null, ['class'=>'form-control input-sm']) !!}
        </div>
    </div>
